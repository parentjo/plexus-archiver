 ...
 */
public class CBZip2OutputStream2
    ...
    implements BZip2Constants
{
    ...
    */
        ...
        while ( true )
        {
            ...
            for ( i = 1; i <= alphaSize; i++ )
            {
                ...
                heap[ nHeap ] = i;
                {
                    ...
                    tmp = heap[ zz ];
                    int hzz2;
                    while ( weight[ tmp ] < weight[ (hzz2 = heap[zz >> 1])  ] )
                    {
                        heap[ zz ] = hzz2;
                        zz >>= 1;
                    }
    ...
    private static void operation(int[] heap, int[] weight, int nHeap)
    {
        int zz = 1, yy, tmp;
        tmp = heap[ zz ];
        int whzz = weight[tmp];
    ...
    */
    ...
    public CBZip2OutputStream2(OutputStream inStream)
        throws IOException
    {
        this( inStream, 9 );
    }

    public CBZip2OutputStream2(OutputStream inStream, int inBlockSize)
        throws IOException
    {
        block = null;
        quadrant = null;
        ...
        throws IOException
    {
        ...
        {
            Arrays.fill(len[t], 0, alphaSize, (char) GREATER_ICOST);
        }
        ...
        while ( nPart > 0 )
        {
            ...
            char[] tmp = len[nPart - 1];
            for ( v = 0; v < alphaSize; v++ )
            {
                if ( v >= gs && v <= ge )
                {
                    tmp[ v ] = (char) LESSER_ICOST;
                }
                else
                {
                    tmp[ v ] = (char) GREATER_ICOST;
                }
            }
    ...
    private void simpleSort( int lo, int hi, int d )
    {
        ...
        for ( ; hp >= 0; hp-- )
        {
            ...
            while ( true )
            {
                ...
                j = i;
                int z;
                int threshold = lo + h - 1;
                while ( fullGtU( (z = zptr[ j - h ]) + d, v + d ) )
                {
                    zptr[ j ] = z;
                    j = j - h;
                    if ( j <= threshold )
